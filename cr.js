...
function crRender(){
  ...
  // ── Upgrade / Downgrade calc ──────────────────────────────
  var savedRows=rows.filter(crIsSaved);
  var lostRows=rows.filter(function(r){return crOutcome(r)==="lost";});
  var savedUpg=savedRows.filter(crIsUpgrade).length;
