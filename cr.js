...
function crBuildDistBars(dist){
  dist=dist||{};
  if(!Object.keys(dist).length)return'<div style="color:#8b949e;font-size:12px">No distribution data</div>';
  ...
  return bars+'<div style="margin-left:8px;display:flex;flex-direction:column;justify-content:flex-end;padding-bottom:18px">'+
    '<div style="width:1px;height:80px;background:#388bfd;position:relative">'+
    '<div style="position:absolute;left:4px;top:0;font-size:9px;color:#388bfd;white-space:nowrap">7d target</div></div></div>';
}
