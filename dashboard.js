...
function toggleCohortSkuDetail(e,sku){
  ...
  var h='<td colspan="8" style="padding:0 0 6px 28px">'
    ...
    +'<th style="padding:5px 8px;text-align:left;color:#64748b;font-weight:600;border-bottom:1px solid #e2e8f0">Program Name</th>'
    +'<th style="padding:5px 8px;text-align:left;color:#64748b;font-weight:600;border-bottom:1px solid #e2e8f0">Contact ID</th>'
    +'<th style="padding:5px 8px;text-align:left;color:#64748b;font-weight:600;border-bottom:1px solid #e2e8f0">Client Name</th>'
  ...
  rows.forEach(function(row){
    ...
    h+='<tr style="border-top:1px solid #f1f5f9">'
      ...
      +'<td style="padding:4px 8px;font-size:10px;color:#334155;max-width:180px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap" title="'+(row[9]||"").replace(/"/g,"&quot;")+'">'+(row[9]||"—")+'</td>'
      +'<td style="padding:4px 8px;font-family:monospace;font-size:10px;color:#64748b">'+(row[1]||"")+'</td>'
      +'<td style="padding:4px 8px;font-size:10px;color:#334155;max-width:160px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap" title="'+(row[21]||"").replace(/"/g,"&quot;")+'">'+(row[21]||"—")+'</td>'
