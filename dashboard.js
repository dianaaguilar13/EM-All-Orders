...
function getDecompLevel(levelIdx,prevSelections){
  ...
  if(levelIdx===2){
    ...
    var selAct=prevSelections[0]===0?"Active":"Inactive";
    var myMap={};
    Object.keys(tree).forEach(function(my){
  ...
  if(levelIdx===3){
    ...
    var selMy=myItems[prevSelections[1]]&&myItems[prevSelections[1]].l;
    if(!selMy)return[];
  ...
  if(levelIdx===4){
    ...
    var selRm=rmItems[prevSelections[2]]&&rmItems[prevSelections[2]].l;
  ...
  if(levelIdx===5){
    ...
    var selCncl=cnclItems[prevSelections[3]]&&cnclItems[prevSelections[3]].l;
